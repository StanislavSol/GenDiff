...
def get_files():
    path_file1 = '/home/ssol/python-project-50/test/fixtures/file1.json'
    path_file2 = '/home/ssol/python-project-50/test/fixtures/file2.json'
    path_sample_file = '/home/ssol/python-project-50/test/fixtures/sample_output.json'
